...
function RMSE = testFunction_for_students_MTb(angle,scale,thres, win_len)   % teamName
...
% Train Model
modelParameters = positionEstimatorTraining(trainingData, angle, scale, thres, win_len);
